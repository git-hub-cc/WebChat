...
const ThemeLoader = {
    ...
    themes: {
        ...
        "崩坏3-浅色": { name: "崩坏3（内置tts）", css: "css/崩坏3-浅色.css", dataJs: "data/崩坏3.js" },
        "崩坏3-深色": { name: "崩坏3（内置tts）", css: "css/崩坏3-深色.css", dataJs: "data/崩坏3.js" },
        "鸣潮-浅色": { name: "鸣潮（内置tts）", css: "css/鸣潮-浅色.css", dataJs: "data/鸣潮.js" },
        "鸣潮-深色": { name: "鸣潮（内置tts）", css: "css/鸣潮-深色.css", dataJs: "data/鸣潮.js" },
        "星穹铁道-浅色": { name: "星穹铁道（内置tts）", css: "css/星穹铁道-浅色.css", dataJs: "data/星穹铁道.js" },
        "星穹铁道-深色": { name: "星穹铁道（内置tts）", css: "css/星穹铁道-深色.css", dataJs: "data/星穹铁道.js" },
